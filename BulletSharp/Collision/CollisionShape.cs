...
namespace BulletSharp
{
	public abstract class CollisionShape : BulletDisposableObject
	{
		...
		public void CalculateTemporalAabbRef(ref Matrix4 curTrans, ref Vector3 linvel, ref Vector3 angvel,
		...
		public void CalculateTemporalAabb(Matrix4 curTrans, Vector3 linvel, Vector3 angvel,
			float timeStep, out Vector3 temporalAabbMin, out Vector3 temporalAabbMax)
		{
		...
		public void GetAabbRef(ref Matrix4 transformation, out Vector3 aabbMin, out Vector3 aabbMax)
		{
			btCollisionShape_getAabb(Native, ref transformation, out aabbMin, out aabbMax);
		}

		public void GetAabb(Matrix4 transformation, out Vector3 aabbMin, out Vector3 aabbMax)
		{
			btCollisionShape_getAabb(Native, ref transformation, out aabbMin, out aabbMax);
		}
