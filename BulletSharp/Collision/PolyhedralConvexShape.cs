...
namespace BulletSharp
{
	...
	public abstract class PolyhedralConvexAabbCachingShape : PolyhedralConvexShape
	{
		...
		public void GetNonvirtualAabbRef(ref Matrix4 trans, out Vector3 aabbMin, out Vector3 aabbMax,
			float margin)
		{
		...
		public void GetNonvirtualAabb(Matrix4 trans, out Vector3 aabbMin, out Vector3 aabbMax,
			float margin)
		{
			btPolyhedralConvexAabbCachingShape_getNonvirtualAabb(Native, ref trans,
				out aabbMin, out aabbMax, margin);
