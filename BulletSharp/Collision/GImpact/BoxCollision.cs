...
namespace BulletSharp
{
	public class BoxBoxTransformCache : BulletDisposableObject
	{
		...
		public void CalculateFromFullInvertRef(ref Matrix4 transform0, ref Matrix4 transform1)
		{
			BT_BOX_BOX_TRANSFORM_CACHE_calc_from_full_invert(Native, ref transform0, ref transform1);
		}

		public void CalculateFromFullInvert(Matrix4 transform0, Matrix4 transform1)
		{
			BT_BOX_BOX_TRANSFORM_CACHE_calc_from_full_invert(Native, ref transform0, ref transform1);
		}

		public void CalculateFromFullHomogenicRef(ref Matrix4 transform0, ref Matrix4 transform1)
		{
			BT_BOX_BOX_TRANSFORM_CACHE_calc_from_homogenic(Native, ref transform0, ref transform1);
		}

		public void CalculateFromFullHomogenic(Matrix4 transform0, Matrix4 transform1)
		{
			BT_BOX_BOX_TRANSFORM_CACHE_calc_from_homogenic(Native, ref transform0, ref transform1);
		}
	...
	public sealed class Aabb : BulletDisposableObject
	{
		...
		public void ApplyTransformRef(ref Matrix4 transform)
		{
		...
		public bool OverlappingTransConservativeRef(Aabb box, ref Matrix4 transform1To0)
		{
			return btAABB_overlapping_trans_conservative(Native, box.Native, ref transform1To0);
		}

		public bool OverlappingTransConservative(Aabb box, Matrix4 transform1To0)
		{
			return btAABB_overlapping_trans_conservative(Native, box.Native, ref transform1To0);
		}
