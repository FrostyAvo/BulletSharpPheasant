...
namespace BulletSharp
{
	public class ConvexShape : CollisionShape
	{
		...
		*/
		...
		public void GetAabbNonVirtual(Matrix4 t, out Vector3 aabbMin, out Vector3 aabbMax)
		{
			btConvexShape_getAabbNonVirtual(Native, ref t, out aabbMin, out aabbMax);
		}

		public void GetAabbSlow(Matrix4 t, out Vector3 aabbMin, out Vector3 aabbMax)
		{
		...
		public void ProjectRef(ref Matrix4 trans, ref Vector3 dir, out float minProj, out float maxProj,
		...
		public void Project(Matrix4 trans, Vector3 dir, out float minProj, out float maxProj,
			out Vector3 witnesPtMin, out Vector3 witnesPtMax)
		{
			btConvexShape_project(Native, ref trans, ref dir, out minProj, out maxProj,
				out witnesPtMin, out witnesPtMax);
