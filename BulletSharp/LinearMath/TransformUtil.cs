...
namespace BulletSharp
{
	...
	{
		public static void CalculateDiffAxisAngle(ref Matrix4 transform0, ref Matrix4 transform1,
		...
		public static void CalculateVelocity(ref Matrix4 transform0, ref Matrix4 transform1,
		...
		public static void IntegrateTransform(ref Matrix4 curTrans, ref Vector3 linvel, ref Vector3 angvel,
			float timeStep, out Matrix4 predictedTransform)
		{
	...
	public class ConvexSeparatingDistanceUtil : BulletDisposableObject
	{
		...
		public void InitSeparatingDistance(ref Vector3 separatingVector, float separatingDistance,
			ref Matrix4 transA, ref Matrix4 transB)
		{
		...
		public void UpdateSeparatingDistance(ref Matrix4 transA, ref Matrix4 transB)
		{
