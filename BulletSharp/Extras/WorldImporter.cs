...
namespace BulletSharp
{
	public class WorldImporter
	{
            ...
            switch (type)
            {
                ...
                case BroadphaseNativeType.CompoundShape:
                {
                    ...
                    for (int i = 0; i < numChildShapes; i++)
                    {
                        ...
                        Matrix4 localTransform = BulletReader.ToMatrix(childShapes, cs + CompoundShapeChildData.Offset("Transform"));
        ...
        protected void ConvertConstraintFloat(RigidBody rigidBodyA, RigidBody rigidBodyB, byte[] data, int fileVersion, Dictionary<long, byte[]> libPointers)
        {
            ...
            switch (type)
            {
                ...
                case TypedConstraintType.ConeTwist:
                {
                    ...
                    Matrix4 rbaFrame = BulletReader.ToMatrix(data, ConeTwistConstraintFloatData.Offset("RigidBodyAFrame"));
                    if (rigidBodyA != null && rigidBodyB != null)
                    {
                        Matrix4 rbbFrame = BulletReader.ToMatrix(data, ConeTwistConstraintFloatData.Offset("RigidBodyBFrame"));
                ...
                case TypedConstraintType.D6:
                {
                    ...
                    if (rigidBodyA != null && rigidBodyB != null)
                    {
                        Matrix4 rbaFrame = BulletReader.ToMatrix(data, Generic6DofConstraintFloatData.Offset("RigidBodyAFrame"));
                        Matrix4 rbbFrame = BulletReader.ToMatrix(data, Generic6DofConstraintFloatData.Offset("RigidBodyBFrame"));
                ...
                case TypedConstraintType.D6Spring:
                {
                    ...
                    if (rigidBodyA != null && rigidBodyB != null)
                    {
                        Matrix4 rbaFrame = BulletReader.ToMatrix(data, sixDofData + Generic6DofConstraintFloatData.Offset("RigidBodyAFrame"));
                        Matrix4 rbbFrame = BulletReader.ToMatrix(data, sixDofData + Generic6DofConstraintFloatData.Offset("RigidBodyBFrame"));
                ...
                case TypedConstraintType.D6Spring2:
                {
                    ...
                    if (rigidBodyA != null && rigidBodyB != null)
                    {
                        Matrix4 rbaFrame = BulletReader.ToMatrix(data, Generic6DofSpring2ConstraintFloatData.Offset("RigidBodyAFrame"));
                        Matrix4 rbbFrame = BulletReader.ToMatrix(data, Generic6DofSpring2ConstraintFloatData.Offset("RigidBodyBFrame"));
                ...
                case TypedConstraintType.Hinge:
                {
                    ...
                    Matrix4 rbaFrame = BulletReader.ToMatrix(data, HingeConstraintFloatData.Offset("RigidBodyAFrame"));
                    int useReferenceFrameA = BitConverter.ToInt32(data, HingeConstraintFloatData.Offset("UseReferenceFrameA"));
                    if (rigidBodyA != null && rigidBodyB != null)
                    {
                        Matrix4 rbbFrame = BulletReader.ToMatrix(data, HingeConstraintFloatData.Offset("RigidBodyBFrame"));
                ...
                case TypedConstraintType.Slider:
                {
                    ...
                    Matrix4 rbbFrame = BulletReader.ToMatrix(data, SliderConstraintFloatData.Offset("RigidBodyBFrame"));
                    int useLinearReferenceFrameA =
                        BitConverter.ToInt32(data, SliderConstraintFloatData.Offset("UseLinearReferenceFrameA"));
                    if (rigidBodyA != null && rigidBodyB != null)
                    {
                        Matrix4 rbaFrame = BulletReader.ToMatrix(data, SliderConstraintFloatData.Offset("RigidBodyAFrame"));
                ...
                case TypedConstraintType.Fixed:
                {
                    ...
                    Matrix4 rbaFrame = rigidBodyA.WorldTransform;
                    Matrix4 rbbFrame = rigidBodyB.WorldTransform;
                    Matrix4 sharedFrame = Matrix4.CreateTranslation(0.5f * (rbaFrame.ExtractTranslation() + rbbFrame.ExtractTranslation()));
                    Matrix4.Invert(rbaFrame, out rbaFrame);
                    Matrix4.Invert(rbbFrame, out rbbFrame);
        ...
        protected void ConvertRigidBodyFloat(byte[] data, Dictionary<long, byte[]> libPointers)
        {
            ...
            Matrix4 startTransform = BulletReader.ToMatrix(data, cod + CollisionObjectFloatData.Offset("WorldTransform"));
        ...
        protected void ConvertRigidBodyDouble(byte[] data, Dictionary<long, byte[]> libPointers)
        {
            int cod = RigidBodyFloatData.Offset("CollisionObjectData");
            long collisionShapePtr = BulletReader.ToPtr(data, cod + CollisionObjectFloatData.Offset("CollisionShape"));
            Matrix4 startTransform = BulletReader.ToMatrixDouble(data, cod + CollisionObjectFloatData.Offset("WorldTransform"));
            long namePtr = BulletReader.ToPtr(data, cod + CollisionObjectFloatData.Offset("Name"));
		...
		public CollisionObject CreateCollisionObject(ref Matrix4 startTransform, CollisionShape shape, string bodyName)
		{
		...
		public ConeTwistConstraint CreateConeTwistConstraint(RigidBody rbA, ref Matrix4 rbAFrame)
		{
		...
		public ConeTwistConstraint CreateConeTwistConstraint(RigidBody rbA, RigidBody rbB, ref Matrix4 rbAFrame, ref Matrix4 rbBFrame)
		{
        ...
        */
		...
		public Generic6DofConstraint CreateGeneric6DofConstraint(RigidBody rbB, ref Matrix4 frameInB, bool useLinearReferenceFrameB)
		{
		...
		public Generic6DofConstraint CreateGeneric6DofConstraint(RigidBody rbA, RigidBody rbB, ref Matrix4 frameInA, ref Matrix4 frameInB, bool useLinearReferenceFrameA)
		{
		...
		public Generic6DofSpringConstraint CreateGeneric6DofSpringConstraint(RigidBody rbA, RigidBody rbB, ref Matrix4 frameInA, ref Matrix4 frameInB, bool useLinearReferenceFrameA)
		{
        ...
        public Generic6DofSpring2Constraint CreateGeneric6DofSpring2Constraint(RigidBody rbA, RigidBody rbB, ref Matrix4 frameInA, ref Matrix4 frameInB, RotateOrder rotateOrder)
        {
		...
		public HingeConstraint CreateHingeConstraint(RigidBody rbA, RigidBody rbB, ref Matrix4 rbAFrame, ref Matrix4 rbBFrame, bool useReferenceFrameA)
		{
        ...
        public HingeConstraint CreateHingeConstraint(RigidBody rbA, RigidBody rbB, ref Matrix4 rbAFrame, ref Matrix4 rbBFrame)
		{
        ...
        public HingeConstraint CreateHingeConstraint(RigidBody rbA, ref Matrix4 rbAFrame, bool useReferenceFrameA)
		{
        ...
        public HingeConstraint CreateHingeConstraint(RigidBody rbA, ref Matrix4 rbAFrame)
		{
		...
		public virtual RigidBody CreateRigidBody(bool isDynamic, float mass, ref Matrix4 startTransform, CollisionShape shape, string bodyName)
		{
		...
		public SliderConstraint CreateSliderConstraint(RigidBody rbB, ref Matrix4 frameInB, bool useLinearReferenceFrameA)
		{
		...
		public SliderConstraint CreateSliderConstraint(RigidBody rbA, RigidBody rbB, ref Matrix4 frameInA, ref Matrix4 frameInB, bool useLinearReferenceFrameA)
		{
